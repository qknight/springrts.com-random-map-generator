...
//     QModelIndex m4 = model->insertModule("Selector::Select",     QPoint(100,0));
    QModelIndex m4 = model->insertModule("Generator::Perlin",     QPoint(-250,0));
    QModelIndex m3 = model->insertModule("Modifier::Invert",     QPoint(-50,150));
    QModelIndex m2 = model->insertModule("Modifier::Invert",     QPoint(150,150));
...
// 
//    QModelIndex m4_input1 = m4.child(model->rowCount(m4)-2,0);
