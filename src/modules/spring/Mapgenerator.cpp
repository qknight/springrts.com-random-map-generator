...
NoiseNetwork* Mapgenerator::network() {
  ...
  //   2. construct the local module (in this case Perlin)
       noise::module::Mapgenerator* m_Mapgenerator = new noise::module::Mapgenerator();
       noiseNetwork->addModule(m_Mapgenerator);
